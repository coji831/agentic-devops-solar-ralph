...
<!-- ============================================================
  ...
  12. [ ] Add SOLAR-specific instructions via solar.instructions.md (generated by installer)
  ============================================================ -->

Operational playbook for AI agents contributing to `[YOUR-REPO-NAME]`.

> **Setup:** Fill in every `[POST-IMPLEMENT]` block below. SOLAR-specific instructions are in `.github/instructions/solar.instructions.md` (generated by installer).
