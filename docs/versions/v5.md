...
> **Status:** RELEASED — v5.3.1 (2026-09-05). Runtime (`solar-governor/`)
...
> eval battery 18/18. v5.3.1 = driver-orchestrated only (the self-chain entry
> dispatch was removed). Full epic-25 with the detailed pipeline = next, on
> `main` after installing the runtime.
> **Release:** v5.3.1 (2026-09-05)
