...
> **Status:** RELEASED — v5.6.1 (2026-09-19). v5.4.0 gave the **HTTP runner full role capacity
...
said "checkpoint = source, ledger = render" — but a *render* that overwrites is a scratch
