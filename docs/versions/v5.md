...
> **Status:** IMPLEMENTING — v5.3 runtime skeleton (`solar-governor/`) done; mandarin registry + model executor next; B3 pilot on mandarin epic 25.
> **Release:** v5.3 (target after pilot)
