> **SOLAR v4 Reference** — Not generated by `solar-install.prompt.md` (base install). Moved here from `.github/solar-system/protocols/` for future consideration. Describes v4 Phase 3 session resumption mechanics built on `/memories/session/checkpoint.md` and v4 pipeline constructs not present in the current base harness.

# Session Resumption Protocol

**Path (original):** `.github/solar-system/protocols/session-resumption.md`
